...
import {DashboardConfigComponent} from "./config/dashboard.config.component";
...
export class DashboardLayoutComponent implements OnDestroy {
  ...
  constructor(public layoutService: DashboardLayoutService, public renderer: Renderer2, public router: Router) {
